...
const highlights = [
  {
    ...
    title: "A Genuine Spa in Greater Noida",
    desc: "A real spa in Greater Noida outlet — trained therapists, premium oils, and a private room for every session, not a rushed neighbourhood parlour visit.",
  },
  {
    icon: <FaHandSparkles className="text-2xl text-emerald-600" />,
    title: "Minutes From Pari Chowk & Knowledge Park",
    desc: "Close to Pari Chowk, Knowledge Park, and the Greater Noida Expressway, easy to reach from Alpha, Beta, Gamma, and Gaur City.",
  },
  {
    icon: <FaHeart className="text-2xl text-rose-500" />,
    title: "Outlet, Home & Resort Spa Options",
    desc: "Visit our outlet, or book a resort spa in Greater Noida delivered directly to your room at Jaypee Greens or Crowne Plaza.",
  },
];

const services = [
  { title: "Full Body Massage", desc: "A complete full body massage in Greater Noida that eases muscle tension and leaves you feeling genuinely refreshed from head to toe.", href: "/full-body-massage-in-delhi" },
  { title: "Deep Tissue Massage", desc: "Firm, focused deep tissue massage in Greater Noida that targets chronic knots in the back, neck, and shoulders built up from long commutes.", href: "/deep-tissue-massage-in-delhi" },
  ...
  { title: "Couples Massage", desc: "One private room, two therapists — a shared couple massage in Greater Noida experience designed for two people to unwind together.", href: "/couples-massage-in-delhi" },
  { title: "Sandwich Massage", desc: "A two-therapist session that delivers deeper relaxation and faster stress relief than a standard single-therapist massage.", href: "/sandwich-massage-in-delhi" },
...
const pricingPlans = [
  { title: "Spa Outlet", price: "₹1999", desc: "A private spa in Greater Noida session at our outlet, with premium oils and complete privacy from start to finish.", features: ["Oil Massage", "Cream Massage", "Private Room", "60 min Session"], icon: <FaSpa className="text-amber-500" />, highlight: false, badge: "Starter" },
  { title: "Home Spa", price: "₹15000", desc: "The same genuine massage experience, delivered to your home anywhere across Greater Noida.", features: ["Therapist of Choice", "Private Setting", "Aromatherapy Add-on", "90 min Session"], icon: <FaCrown className="text-amber-500" />, highlight: false, badge: "Flexible" },
  { title: "Resort & Hotel Spa", price: "₹20000", desc: "A longer, indulgent session delivered to your room at Jaypee Greens Resort, Crowne Plaza, or any hotel in Greater Noida.", features: ["Foreign Therapist Option", "Private Suite", "Facial Add-on", "120 min Session"], icon: <FaHotel className="text-amber-500" />, highlight: true, badge: "Most Popular" },
];

const faqs = [
  { question: "Is there a good spa in Greater Noida?", answer: "Yes, Spa Delhi runs a genuine spa in Greater Noida, close to Pari Chowk and Knowledge Park, offering full body, deep tissue, and B2B massage in a private, hygienic setting for guests across the city." },
  { question: "Do you offer spa service at Jaypee Greens Resort Greater Noida?", answer: "Yes, guests staying at Jaypee Greens Resort Greater Noida (also known as JP Resort Greater Noida or Jaypee Greens Golf & Spa Resort) can request an in-room therapist through our hotel spa service, available on request." },
  { question: "Can I book a Crowne Plaza Greater Noida spa session?", answer: "Yes, our Crowne Plaza Greater Noida spa service lets guests staying at the hotel request a private, in-room massage session with a certified therapist, booked in advance on WhatsApp." },
  { question: "What makes Spa Delhi the best spa in Greater Noida?", answer: "Certified therapists, transparent pricing, hygienic private rooms, and flexible outlet, home, and resort spa options make us the best spa in Greater Noida for residents and hotel guests alike." },
  { question: "Do you provide spa service at other resorts in Greater Noida?", answer: "Yes, alongside Jaypee Greens and Crowne Plaza, we cover most major resort and hotel properties across Greater Noida on request — just share your hotel name and room details while booking." },
  { question: "Can I book a full night spa near Greater Noida, Uttar Pradesh?", answer: "Evening and late-night appointments can be booked in advance through our 24/7 WhatsApp and Telegram help desk, subject to therapist availability at the time you need, so a full night spa near Greater Noida, Uttar Pradesh can usually be arranged with prior notice." },
  { question: "Which areas of Greater Noida do you cover?", answer: "We cover Alpha, Beta, Gamma, Delta, and Pari Chowk sectors, along with Knowledge Park and Gaur City, through our outlet, home spa, and resort spa network." },
  { question: "How much does a full body massage cost in Greater Noida?", answer: "A full body massage in Greater Noida at our outlet starts from ₹1999 for the first visit. Home spa starts from ₹15,000 and resort or hotel spa from ₹20,000, depending on duration and treatment." },
  { question: "Do you offer home spa in Greater Noida?", answer: "Yes, alongside our outlet, we offer home spa across Greater Noida. Our therapist arrives fully equipped for a relaxing, hygienic session at your residence." },
];
    ...
    <main className="min-h-screen bg-[#fffaf6] text-[#2f241d]">
      ...
      <section className="relative overflow-hidden bg-[radial-gradient(circle_at_top_left,_rgba(245,158,11,0.18),_transparent_30%),linear-gradient(135deg,_#fef7ed_0%,_#fffaf5_45%,_#fef3f2_100%)]">
        ...
        <nav aria-label="Breadcrumb" className="relative z-10 mx-auto flex max-w-7xl items-center gap-2 px-6 pt-6 text-sm text-[#8a7a6d]">
          ...
          <span className="font-medium text-[#3a2e2a]">Spa in Greater Noida</span>
        </nav>
        <div className="relative mx-auto grid max-w-7xl gap-10 px-6 py-16 lg:grid-cols-[1.02fr_0.98fr] lg:py-20">
          <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="flex flex-col justify-center">
            <div className="mb-4 inline-flex w-fit items-center gap-2 rounded-full border border-amber-200 bg-white/90 px-4 py-2 text-sm font-semibold text-amber-700 shadow-sm">
              <FaStar className="text-amber-500" /> GREATER NOIDA OUTLET
            </div>
            <h1 className="max-w-2xl text-4xl font-bold leading-tight text-[#3a2e2a] md:text-5xl lg:text-5xl">
              Best Spa in <span className="text-amber-700">Greater Noida</span> — Near Jaypee Greens &amp; Crowne Plaza
            </h1>
            <p className="mt-4 max-w-2xl text-lg leading-relaxed text-gray-700">
              Looking for a spa in Greater Noida? Spa Delhi is a trusted destination for full body, deep tissue, and B2B massage, with outlet, home, and resort spa options across Pari Chowk, Knowledge Park, and every major sector. Guests at the Jaypee Greens Resort Greater Noida and Crowne Plaza Greater Noida spa can request an in-room therapist directly. First visit from ₹1999.
            </p>
            <p className="mt-4 max-w-2xl leading-relaxed text-gray-600">
              Whether you're staying at a resort in Greater Noida, working from Knowledge Park, or live around Alpha, Beta, or Gamma sectors, our outlet and home spa network mean the best spa in Greater Noida experience is never far away.
            </p>
          ...
          <motion.div initial={{ opacity: 0, x: 24 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.7 }} className="relative flex items-center">
            <div className="w-full rounded-[32px] border border-amber-100 bg-white p-3 shadow-[0_20px_60px_-20px_rgba(0,0,0,0.25)]">
              <div className="relative h-[410px] overflow-hidden rounded-[24px]">
                <Image src="/images/fpkdl.com_960_1758962686_masseur-doing-massage-woman-s-back-spa-salon-with-many-candles_355000-245.jpg" alt="Therapist giving a massage at our spa in Greater Noida" fill className="object-cover" priority />
              </div>
            </div>
      ...
      <section className="mx-auto max-w-6xl px-6 py-16">
        <div className="mb-10 text-center">
          ...
          <h2 className="mt-3 text-3xl font-bold text-[#3a2e2a] md:text-4xl">What Makes Our Greater Noida Spa Different?</h2>
        </div>
        ...
        <div className="grid gap-10 overflow-hidden rounded-[32px] border border-amber-100 bg-white p-6 shadow-lg lg:grid-cols-2 lg:items-center lg:p-10">
          <motion.div initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.5 }} className="relative min-h-[420px]">
            <div className="absolute left-0 top-0 z-10 w-40">
              <p className="font-serif text-lg text-[#3a2e2a]">Resort Spa at</p>
              <p className="font-serif text-3xl italic text-amber-700">Jaypee Greens</p>
              <p className="mt-2 text-[11px] font-semibold uppercase tracking-[0.15em] text-gray-500">On-Request Resort Spa in Greater Noida</p>
            </div>
            ...
            <div className="absolute right-0 top-0 w-[55%] overflow-hidden rounded-2xl bg-gradient-to-br from-amber-600 to-amber-800 p-2 shadow-xl sm:w-[60%]">
              <div className="relative h-32 w-full overflow-hidden rounded-xl sm:h-40">
                <Image src="/images/Crowne_Plaza_Greater_Noida.jpg" alt="Crowne Plaza Greater Noida spa" fill className="object-cover" />
              </div>
            </div>

            <div className="absolute bottom-0 left-0 h-64 w-[65%] overflow-hidden rounded-[24px] border-4 border-white shadow-xl sm:h-72">
              <Image src="/images/fpkdl.com_960_1758981994_female-masseur-preparing-bed-massage-session_23-2150461390.jpg" alt="Body massage in Greater Noida" fill className="object-cover" />
            </div>
          ...
          <motion.div initial={{ opacity: 0, x: 20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.5 }} className="mt-6 lg:mt-0">
            ...
            <h2 className="mt-3 text-3xl font-bold text-[#3a2e2a] md:text-4xl">Best Massage Spa in Greater Noida</h2>
            <p className="mt-4 leading-relaxed text-gray-700">
              Looking for the best massage spa in Greater Noida? Our spa centre sits close to Pari Chowk and Knowledge Park, offering calm interiors, soothing music, and premium aromatic oils. Guests staying at the JP Greens Resort Greater Noida or a resort in Greater Noida nearby can also request our therapists directly to their room.
            </p>
            <p className="mt-4 leading-relaxed text-gray-700">
              Our therapists are trained professionals from India and abroad, specialising in traditional and modern massage technique. Whether you prefer a gentle aromatherapy massage, an invigorating deep tissue massage, or a full body massage in Greater Noida, every session is personalised to your body's needs and your preferred pressure.
            </p>
      ...
      <section className="bg-[#f7efe8] py-16">
        <div className="mx-auto max-w-5xl px-6 text-center">
          <h2 className="text-3xl font-bold text-[#3a2e2a] md:text-4xl">Best Spa in Greater Noida — Get Full Body Massage at Home &amp; Resort</h2>
          <p className="mx-auto mt-5 max-w-3xl leading-relaxed text-gray-600">
            Welcome to Spa Delhi — the best spa in Greater Noida. If you're tired, stressed, or need a refreshing break, our spa in Greater Noida outlet is your perfect wellness destination. We offer a clean, luxury, and 100% hygienic ambience with a calm and secure environment for complete relaxation.
          </p>
          <p className="mx-auto mt-4 max-w-3xl leading-relaxed text-gray-600">
            With 24+ spa outlets across Delhi NCR, we're right here for you near Pari Chowk, Knowledge Park, and the Greater Noida Expressway. Whether you want a quick stress-relief session or a deep muscle relaxation therapy, our certified and professional therapists at Spa Delhi ensure a world-class spa experience every time.
          </p>
          <p className="mx-auto mt-4 max-w-3xl leading-relaxed text-gray-600">
            Guests staying at the Jaypee Greens Resort Greater Noida, Crowne Plaza Greater Noida, or any other resort in Greater Noida regularly choose our spa because we keep every detail consistent — the same trained hands, the same quality oils, and the same honest pricing on every single visit.
          </p>
      ...
      <section className="mx-auto max-w-6xl px-6 py-16 lg:py-20">
        <div className="grid gap-10 lg:grid-cols-2 lg:items-center">
          <motion.div initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.5 }}>
            <p className="text-sm font-semibold uppercase tracking-[0.3em] text-[#3a2e2a]">Greater Noida</p>
            ...
            <div className="mt-5 space-y-4 text-gray-700">
              <p>
                At Spa Delhi in Greater Noida, we offer a delightful and truly relaxing experience to relieve your body and mind of pain. With 24+ spa outlets across Delhi, Gurgaon, and Noida, our spa in Greater Noida is known for professional body massage delivered by certified therapists.
              </p>
              <p>
              ...
              <p>
                If you want a trusted massage spa in Greater Noida, look for experienced therapists, transparent pricing, and complete cleanliness — and Spa Delhi in Greater Noida ticks all boxes. That's why we're the first choice for the best spa in Greater Noida and across the wider NCR.
              </p>
            </div>
            <a href="https://t.me/+a5Bu6FBPN9FlOWM9" className="mt-6 inline-flex items-center gap-2 rounded-full bg-amber-600 px-6 py-3 font-semibold text-white shadow-lg transition hover:bg-amber-700">
              <FaTelegram /> Join Telegram Channel
          ...
          <motion.div initial={{ opacity: 0, x: 20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.5 }} className="relative h-72 overflow-hidden rounded-[28px] shadow-lg lg:h-96">
            <Image src="/images/fpkdl.com_960_1758980524_tranquil-oasis-with-plush-massage-table-adorned-with_1126694-2523.jpg" alt="Luxury spa Greater Noida treatment room" fill className="object-cover" />
          </motion.div>
        </div>
      </section>
      ...
      <section className="bg-[#fdf2e8] py-16 lg:py-20">
        <div className="mx-auto max-w-6xl px-6">
          <div className="mb-12 text-center">
            <p className="text-sm font-semibold uppercase tracking-[0.3em] text-amber-700">About Our Greater Noida Outlet</p>
            <h2 className="mt-3 text-3xl font-bold text-[#3a2e2a] md:text-4xl">Spa in Greater Noida — A Trusted Body Massage &amp; Wellness Centre</h2>
          </div>
          ...
          <div className="grid gap-10 lg:grid-cols-[0.85fr_1.15fr] lg:items-center">
            ...
            >
              <Image src="/images/hotel3.webp" alt="Luxury spa Greater Noida treatment room" fill className="object-cover" />
            </motion.div>

            <div>
              <p className="text-gray-700">
                Spa Delhi is the best spa in Greater Noida for guests across Alpha, Beta, Gamma, and Knowledge Park — a real spa in Greater Noida outlet, not a generic neighbourhood parlour. Our body massage spa covers full body, deep tissue, B2B, and couple massage, with home and resort spa available on request.
              </p>
              <div className="mt-6 grid gap-4 sm:grid-cols-2">
                <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.4 }} className="rounded-2xl border border-amber-100 bg-white p-5 shadow-sm">
                  ...
                  <h3 className="text-base font-semibold text-[#3a2e2a]">Luxury Spa in Greater Noida</h3>
                  <p className="mt-2 text-sm leading-relaxed text-gray-600">A refined, premium ambience close to Pari Chowk and the Greater Noida Expressway.</p>
                </motion.div>
                <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.4, delay: 0.05 }} className="rounded-2xl border border-amber-100 bg-white p-5 shadow-sm">
                  ...
                  <p className="mt-2 text-sm leading-relaxed text-gray-600">Trained Indian and foreigner therapists deliver every session with care.</p>
                </motion.div>
                <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.4, delay: 0.1 }} className="rounded-2xl border border-amber-100 bg-white p-5 shadow-sm">
                  ...
                  <h3 className="text-base font-semibold text-[#3a2e2a]">Resort &amp; Hotel Spa</h3>
                  <p className="mt-2 text-sm leading-relaxed text-gray-600">Staying at Jaypee Greens or Crowne Plaza? Resort spa is available on request.</p>
                </motion.div>
                <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.4, delay: 0.15 }} className="rounded-2xl border border-amber-100 bg-white p-5 shadow-sm">
                  ...
                  <p className="mt-2 text-sm leading-relaxed text-gray-600">No hidden charges — book the best spa in Greater Noida on WhatsApp with pricing confirmed upfront.</p>
                </motion.div>
              </div>
            </div>
          </div>
      ...
      <section className="mx-auto max-w-7xl px-6 py-16">
        <div className="grid gap-10 lg:grid-cols-2 lg:items-center">
          <motion.div initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.5 }}>
            ...
            <h2 className="mt-3 text-3xl font-bold text-[#3a2e2a] md:text-4xl">Why Choose Spa Delhi in Greater Noida?</h2>
            <p className="mt-4 leading-relaxed text-gray-700">
              Choosing a spa is about more than booking a massage. At our Greater Noida outlet, we focus on creating a calm, comfortable experience where you can take a proper break from your day.
            </p>
            <p className="mt-4 leading-relaxed text-gray-700">
              Whether you're coming from Knowledge Park, staying at a resort in Greater Noida, or just want some personal time after a long week, our spa experience is built around your comfort.
            </p>
            ...
            <ul className="mt-3 space-y-2 text-gray-700">
              ...
              <li><span className="font-semibold text-[#3a2e2a]">Resort &amp; Hotel Coverage</span> — On-request delivery to Jaypee Greens Resort, Crowne Plaza, and other resorts in Greater Noida.</li>
              <li><span className="font-semibold text-[#3a2e2a]">Evening &amp; Night Booking</span> — Late appointments booked in advance through our 24/7 help desk.</li>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.4, delay: 0.05 }} className="overflow-hidden rounded-2xl bg-gradient-to-br from-[#3a2e2a] to-[#5b3f31] p-6 text-center text-white shadow-lg">
              ...
              <p className="mt-2 text-sm text-white/85">Available 24x7 for outlet, home, and resort spa bookings.</p>
            </motion.div>
      ...
      <section className="mx-auto max-w-7xl px-6 py-16">
        <div className="mb-10 text-center">
          ...
          <h2 className="mt-3 text-3xl font-bold text-[#3a2e2a] md:text-4xl">Meet Our Expert Massage Therapists in Greater Noida</h2>
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
          {[
            ...
            { role: "Foreigner Therapist", specialty: "Aromatherapy & Relaxation", experience: "6+ yrs", image: "/images/staff8.jpg" },
            ...
            >
              <Image src={t.image} alt={`${t.role} at Spa Delhi Greater Noida`} fill className="object-cover transition-transform duration-500 group-hover:scale-110" />
      ...
      <section className="bg-[#f7efe8] py-16">
        <div className="mx-auto max-w-6xl px-6">
          <div className="mb-10 text-center">
            ...
            <h2 className="mt-3 text-3xl font-bold text-[#3a2e2a] md:text-4xl">Explore Our Massage Services in Greater Noida</h2>
          </div>
      ...
      <section className="bg-[#fdf2e8] py-16">
        <div className="mx-auto max-w-5xl px-6 text-center">
          <h2 className="text-3xl font-bold text-[#3a2e2a] md:text-4xl">100% Hygienic &amp; Professional Spa in Greater Noida — Your Safety First</h2>
      ...
      <section id="Pricing" className="bg-[#fdf2e8] py-16">
        <div className="mx-auto max-w-6xl px-6">
          <div className="mb-10 text-center">
            ...
            <h2 className="mt-3 text-3xl font-bold text-[#3a2e2a] md:text-4xl">Spa in Greater Noida Pricing — Transparent &amp; Affordable</h2>
          </div>
      ...
      <section className="mx-auto max-w-4xl px-6 py-16">
        <div className="mb-10 text-center">
          ...
          <h2 className="mt-3 text-3xl font-bold text-[#3a2e2a] md:text-4xl">Your Spa in Greater Noida Questions, Answered</h2>
        </div>
      ...
      <section className="bg-[#f7efe8] py-16">
        <div className="mx-auto max-w-7xl px-6">
          <div className="mb-10 text-center">
            ...
            <p className="mx-auto mt-4 max-w-2xl text-gray-600">
              Not based in Greater Noida? We run 24+ outlets across Delhi NCR — find the one closest to you.
            </p>
            <div className="mx-auto mt-6 h-0.5 w-16 bg-amber-300" />
          </div>
          <div className="grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-5">
            {[
              { title: "Noida", href: "/spa-in-noida", image: "/images/fpkdl.com_960_1758982849_female-masseur-giving-back-massage-client_23-2150461442.jpg" },
              { title: "Lajpat Nagar", href: "/spa-in-lajpat-nagar", image: "/images/spa-in-lajpat-nagar.webp" },
              { title: "Greater Kailash", href: "/spa-in-greater-kailash", image: "/images/fpkdl.com_960_1758981900_woman-getting-back-massage-from-masseur_23-2150461404.jpg" },
              { title: "Connaught Place", href: "/spa-in-connaught-place", image: "/images/spa-in-Connaught-place.png" },
              { title: "Preet Vihar", href: "/spa-in-preet-vihar", image: "/images/fpkdl.com_960_1758982094_exfoliation-with-natural-bristle-brush-dry-brush-massage-preparing-skin-epilation_470400-470.jpg" },
              { title: "Laxmi Nagar", href: "/spa-in-laxmi-nagar", image: "/images/fpkdl.com_750_1758779654_happy-pretty-lady-lying-down-massage-bed-wellness-center-beauty-concept_151013-4029.jpg" },
              { title: "Hauz Khas", href: "/spa-in-hauz-khas", image: "/images/hotel4.jpg" },
              ...
              { title: "Karol Bagh", href: "/spa-in-karol-bagh", image: "/images/fpkdl.com_960_1758982849_female-masseur-giving-back-massage-client_23-2150461442.jpg" },
        ...
        <div className="rounded-[32px] bg-gradient-to-r from-[#3a2e2a] to-[#5b3f31] p-8 text-white shadow-2xl md:p-10">
          <div className="flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
            <div className="max-w-2xl">
              ...
              <h3 className="mt-2 text-3xl font-bold md:text-4xl">Book the Best Spa in Greater Noida — Today</h3>
              <p className="mt-3 leading-relaxed text-white/80">Walk in near Pari Chowk, or connect with us for a home, hotel, or resort spa booking anywhere in Greater Noida.</p>
            </div>
