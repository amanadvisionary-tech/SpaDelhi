...
const highlights = [
  {
    ...
    title: "A Genuine Spa in Hauz Khas",
    desc: "A real body spa hauz khas outlet — trained therapists, premium oils, and a private room for every session, not a rushed neighbourhood parlour visit.",
  },
  {
    icon: <FaHandSparkles className="text-2xl text-emerald-600" />,
    title: "Minutes From Hauz Khas Village & Metro",
    desc: "Close to Hauz Khas Village, Hauz Khas Market, and Hauz Khas Metro Station, easy to reach from Green Park and across South Delhi.",
  },
  {
    icon: <FaHeart className="text-2xl text-rose-500" />,
    title: "Outlet, Home & Hotel Spa Options",
    desc: "Visit our spa in Hauz Khas village outlet, or book a body massage spa in Hauz Khas home service anywhere nearby.",
  },
];
...
const pricingPlans = [
  { title: "Spa Outlet", price: "₹1999", desc: "A private massage hauz khas session at our outlet, with premium oils and complete privacy from start to finish.", features: ["Oil Massage", "Cream Massage", "Private Room", "60 min Session"], icon: <FaSpa className="text-amber-500" />, highlight: false, badge: "Starter" },
  { title: "Home Spa", price: "₹15000", desc: "The same genuine body massage spa in Hauz Khas experience, delivered to your home anywhere nearby.", features: ["Therapist of Choice", "Private Setting", "Aromatherapy Add-on", "90 min Session"], icon: <FaCrown className="text-amber-500" />, highlight: false, badge: "Flexible" },
  { title: "5 Star Hotel Spa", price: "₹20000", desc: "A longer, more indulgent luxury spa in Hauz Khas session delivered at your hotel, with added treatments and premium care.", features: ["Foreign Therapist Option", "Private Suite", "Facial Add-on", "120 min Session"], icon: <FaHotel className="text-amber-500" />, highlight: true, badge: "Most Popular" },
];
  ...
  return (
    <main className="min-h-screen bg-[#fffaf6] text-[#2f241d]">
      ...
      <section className="relative overflow-hidden bg-[radial-gradient(circle_at_top_left,_rgba(245,158,11,0.18),_transparent_30%),linear-gradient(135deg,_#fef7ed_0%,_#fffaf5_45%,_#fef3f2_100%)]">
        <div className="absolute inset-0 bg-[url('/images/fpkdl.com_960_1758982845_cute-woman-relaxing-massage-spa-salon_118454-10400.jpg')] bg-cover bg-center opacity-10" />
        ...
        <div className="relative mx-auto grid max-w-7xl gap-10 px-6 py-16 lg:grid-cols-[1.02fr_0.98fr] lg:py-20">
          <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="flex flex-col justify-center">
            <div className="mb-4 inline-flex w-fit items-center gap-2 rounded-full border border-amber-200 bg-white/90 px-4 py-2 text-sm font-semibold text-amber-700 shadow-sm">
              <FaStar className="text-amber-500" /> HAUZ KHAS OUTLET
            </div>
          ...
          <motion.div initial={{ opacity: 0, x: 24 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.7 }} className="relative flex items-center">
            <div className="w-full rounded-[32px] border border-amber-100 bg-white p-3 shadow-[0_20px_60px_-20px_rgba(0,0,0,0.25)]">
              <div className="relative h-[410px] overflow-hidden rounded-[24px]">
                <Image src="/images/fpkdl.com_960_1758982845_cute-woman-relaxing-massage-spa-salon_118454-10400.jpg" alt="Therapist giving a massage at our spa in Hauz Khas" fill className="object-cover" priority />
              </div>
            </div>
      ...
      <section className="mx-auto max-w-6xl px-6 py-16">
        <div className="mb-10 text-center">
          ...
          <h2 className="mt-3 text-3xl font-bold text-[#3a2e2a] md:text-4xl">What Makes Our Hauz Khas Spa Different?</h2>
        </div>
        ...
        <div className="grid gap-10 overflow-hidden rounded-[32px] border border-amber-100 bg-white p-6 shadow-lg lg:grid-cols-2 lg:items-center lg:p-10">
          <motion.div initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.5 }} className="relative min-h-[420px]">
            <div className="absolute left-0 top-0 z-10 w-40">
              ...
              <p className="mt-2 text-[11px] font-semibold uppercase tracking-[0.15em] text-gray-500">Luxury Spa Outlet in Hauz Khas</p>
            </div>
            ...
            <div className="absolute right-0 top-0 w-[55%] overflow-hidden rounded-2xl bg-gradient-to-br from-amber-600 to-amber-800 p-2 shadow-xl sm:w-[60%]">
              <div className="relative h-32 w-full overflow-hidden rounded-xl sm:h-40">
                <Image src="/images/hotel1.jpeg" alt="Luxury hotel spa in Hauz Khas" fill className="object-cover" />
              </div>
            </div>

            <div className="absolute bottom-0 left-0 h-64 w-[65%] overflow-hidden rounded-[24px] border-4 border-white shadow-xl sm:h-72">
              <Image src="/images/fpkdl.com_960_1758981994_female-masseur-preparing-bed-massage-session_23-2150461390.jpg" alt="Body massage in Hauz Khas" fill className="object-cover" />
            </div>
          ...
          <motion.div initial={{ opacity: 0, x: 20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.5 }} className="mt-6 lg:mt-0">
            ...
            <h2 className="mt-3 text-3xl font-bold text-[#3a2e2a] md:text-4xl">Best Massage Spa in Hauz Khas</h2>
            <p className="mt-4 leading-relaxed text-gray-700">
              Looking for the best massage spa in Hauz Khas? Our spa centre sits close to Hauz Khas Village, Hauz Khas Market, and Hauz Khas Metro Station, offering calm interiors, soothing music, and premium aromatic oils. Whether after a hectic workday or a weekend at the Village, our body spa hauz khas ensures complete rejuvenation.
            </p>
            <p className="mt-4 leading-relaxed text-gray-700">
              Our therapists are trained professionals from India and abroad, specialising in traditional and modern massage technique. Whether you prefer a gentle aromatherapy massage, an invigorating deep tissue massage, or a full body massage in Hauz Khas, every session is personalised to your body's needs and your preferred pressure.
            </p>
      ...
      <section className="bg-[#f7efe8] py-16">
        <div className="mx-auto max-w-5xl px-6 text-center">
          <h2 className="text-3xl font-bold text-[#3a2e2a] md:text-4xl">Best Spa in Hauz Khas — Get Full Body Massage at Home &amp; Hotel</h2>
      ...
      <section className="mx-auto max-w-6xl px-6 py-16 lg:py-20">
        <div className="grid gap-10 lg:grid-cols-2 lg:items-center">
          <motion.div initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.5 }}>
            <p className="text-sm font-semibold uppercase tracking-[0.3em] text-[#3a2e2a]">Hauz Khas</p>
      ...
      <section className="bg-[#fdf2e8] py-16 lg:py-20">
        <div className="mx-auto max-w-6xl px-6">
          <div className="mb-12 text-center">
            <p className="text-sm font-semibold uppercase tracking-[0.3em] text-amber-700">About Our Hauz Khas Outlet</p>
            <h2 className="mt-3 text-3xl font-bold text-[#3a2e2a] md:text-4xl">Spa in Hauz Khas — A Trusted Body Massage &amp; Wellness Centre</h2>
          </div>
          ...
          <div className="grid gap-10 lg:grid-cols-[0.85fr_1.15fr] lg:items-center">
            ...
            >
              <Image src="/images/hotel3.webp" alt="Luxury spa Hauz Khas treatment room" fill className="object-cover" />
            </motion.div>
            ...
            <div>
              ...
              <div className="mt-6 grid gap-4 sm:grid-cols-2">
                <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.4 }} className="rounded-2xl border border-amber-100 bg-white p-5 shadow-sm">
                  ...
                  <h3 className="text-base font-semibold text-[#3a2e2a]">Luxury Spa in Hauz Khas</h3>
      ...
      <section className="mx-auto max-w-7xl px-6 py-16">
        <div className="grid gap-10 lg:grid-cols-2 lg:items-center">
          <motion.div initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.5 }}>
            ...
            <h2 className="mt-3 text-3xl font-bold text-[#3a2e2a] md:text-4xl">Why Choose Spa Delhi in Hauz Khas?</h2>
            <p className="mt-4 leading-relaxed text-gray-700">
            ...
            <p className="mt-4 leading-relaxed text-gray-700">
              Whether you're coming from Green Park, IIT Delhi, or just want some personal time after exploring the Village, our spa experience is built around your comfort.
            </p>
            ...
            <ul className="mt-3 space-y-2 text-gray-700">
              ...
              <li><span className="font-semibold text-[#3a2e2a]">Convenient Location</span> — Minutes from Hauz Khas Village, Hauz Khas Market, and Hauz Khas Metro Station.</li>
              <li><span className="font-semibold text-[#3a2e2a]">Body Massage Spa in Hauz Khas Home Service</span> — Same quality treatment delivered to your residence nearby.</li>
      ...
      <section className="mx-auto max-w-7xl px-6 py-16">
        <div className="mb-10 text-center">
          ...
          <h2 className="mt-3 text-3xl font-bold text-[#3a2e2a] md:text-4xl">Meet Our Expert Massage Therapists in Hauz Khas</h2>
      ...
      <section className="bg-[#f7efe8] py-16">
        <div className="mx-auto max-w-6xl px-6">
          <div className="mb-10 text-center">
            ...
            <h2 className="mt-3 text-3xl font-bold text-[#3a2e2a] md:text-4xl">Explore Our Massage Services in Hauz Khas</h2>
          </div>
      ...
      <section className="bg-[#fdf2e8] py-16">
        <div className="mx-auto max-w-5xl px-6 text-center">
          <h2 className="text-3xl font-bold text-[#3a2e2a] md:text-4xl">100% Hygienic &amp; Professional Spa in Hauz Khas — Your Safety First</h2>
      ...
      <section id="Pricing" className="bg-[#fdf2e8] py-16">
        <div className="mx-auto max-w-6xl px-6">
          <div className="mb-10 text-center">
            ...
            <h2 className="mt-3 text-3xl font-bold text-[#3a2e2a] md:text-4xl">Spa in Hauz Khas Pricing — Transparent &amp; Affordable</h2>
          </div>
      ...
      <section className="mx-auto max-w-4xl px-6 py-16">
        <div className="mb-10 text-center">
          ...
          <h2 className="mt-3 text-3xl font-bold text-[#3a2e2a] md:text-4xl">Your Spa in Hauz Khas Questions, Answered</h2>
        </div>
      ...
      <section className="bg-[#f7efe8] py-16">
        <div className="mx-auto max-w-7xl px-6">
          <div className="mb-10 text-center">
            ...
            <p className="mx-auto mt-4 max-w-2xl text-gray-600">
              Not based in Hauz Khas? We run 24+ outlets across Delhi NCR — find the one closest to you.
            </p>
        ...
        <div className="rounded-[32px] bg-gradient-to-r from-[#3a2e2a] to-[#5b3f31] p-8 text-white shadow-2xl md:p-10">
          <div className="flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
            <div className="max-w-2xl">
              ...
              <h3 className="mt-2 text-3xl font-bold md:text-4xl">Book the Best Spa in Hauz Khas — Today</h3>
