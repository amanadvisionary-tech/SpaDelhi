...
const highlights = [
  {
    ...
    title: "A Genuine Spa in Defence Colony",
    desc: "A real body spa in Defence Colony outlet — trained therapists, premium oils, and a private room for every session, not a rushed neighbourhood parlour visit.",
  },
  {
    icon: <FaHandSparkles className="text-2xl text-emerald-600" />,
    title: "Minutes From Defence Colony Market & Moolchand",
    desc: "Close to Defence Colony Market, the Defence Colony flyover, and Moolchand Metro Station, easy to reach from Lajpat Nagar and South Extension.",
  },
  {
    icon: <FaHeart className="text-2xl text-rose-500" />,
    title: "Outlet, Home & Hotel Spa Options",
    desc: "Visit our spa in Defence Colony market outlet, or book a massage spa in Defence Colony home service anywhere nearby.",
  },
];

const services = [
  { title: "Full Body Massage", desc: "A complete full body massage in Defence Colony that eases muscle tension and leaves you feeling genuinely refreshed from head to toe.", href: "/full-body-massage-in-delhi" },
  { title: "Deep Tissue Massage", desc: "Firm, focused deep tissue massage in Defence Colony that targets chronic knots in the back, neck, and shoulders built up from long hours at a desk.", href: "/deep-tissue-massage-in-delhi" },
  ...
  { title: "Couples Massage", desc: "One private room, two therapists — a shared couple massage in Defence Colony experience designed for two people to unwind together.", href: "/couples-massage-in-delhi" },
...
const pricingPlans = [
  { title: "Spa Outlet", price: "₹1999", desc: "A private massage in Defence Colony session at our outlet, with premium oils and complete privacy from start to finish.", features: ["Oil Massage", "Cream Massage", "Private Room", "60 min Session"], icon: <FaSpa className="text-amber-500" />, highlight: false, badge: "Starter" },
  { title: "Home Spa", price: "₹15000", desc: "The same genuine body spa in Defence Colony experience, delivered to your home anywhere nearby.", features: ["Therapist of Choice", "Private Setting", "Aromatherapy Add-on", "90 min Session"], icon: <FaCrown className="text-amber-500" />, highlight: false, badge: "Flexible" },
  { title: "5 Star Hotel Spa", price: "₹20000", desc: "A longer, more indulgent luxury spa session delivered at your hotel, with added treatments and premium care.", features: ["Foreign Therapist Option", "Private Suite", "Facial Add-on", "120 min Session"], icon: <FaHotel className="text-amber-500" />, highlight: true, badge: "Most Popular" },
];

const faqs = [
  { question: "Is there a good spa in Defence Colony?", answer: "Yes, Spa Delhi runs a genuine spa in Defence Colony, close to Defence Colony Market and Moolchand Metro Station, offering full body, deep tissue, and B2B massage in a private, hygienic setting for guests across South Delhi." },
  { question: "What makes Spa Delhi the best spa in Defence Colony?", answer: "Certified therapists, transparent pricing, hygienic private rooms, and flexible outlet, home, and hotel spa options make us the best spa in Defence Colony for residents and visitors alike." },
  { question: "Do you offer body massage Defence Colony for both men and women?", answer: "Yes, our body massage Defence Colony service welcomes both men and women, with male and female therapist options available — just mention your preference when booking your session." },
  { question: "Is there a spa in Defence Colony Market I can walk into?", answer: "Yes, our spa in Defence Colony Market location is easy to find, with a private, hygienic setting just a short walk from the main market and the Defence Colony flyover." },
  { question: "How do I find a massage Defence Colony service for a same-day session?", answer: "Search massage Defence Colony and message us on WhatsApp or Telegram — our outlet, home spa, and hotel spa teams can usually confirm a same-day appointment depending on therapist availability." },
  { question: "Do you offer body spa in Defence Colony at home?", answer: "Yes, alongside our outlet, we offer body spa in Defence Colony as a home service across South Delhi. Our therapist arrives fully equipped for a relaxing, hygienic session at your residence." },
  { question: "Do you have a Russian spa in Defence Colony?", answer: "Yes, our massage spa in Defence Colony packages include experienced Russian, Thai, and Uzbek therapists alongside our skilled Indian staff, giving guests more variety in massage technique and style." },
  { question: "Can I book a couple massage in Defence Colony?", answer: "Yes, our Defence Colony outlet has private rooms designed for couple massage, including our popular female to male couple massage, so two people can relax together in comfort." },
  { question: "How much does a full body massage cost in Defence Colony?", answer: "A full body massage in Defence Colony at our outlet starts from ₹1999 for the first visit. Home spa starts from ₹15,000 and hotel spa from ₹20,000, depending on duration and treatment." },
];
    ...
    <main className="min-h-screen bg-[#fffaf6] text-[#2f241d]">
        ...
        <div className="relative mx-auto grid max-w-7xl gap-10 px-6 py-16 lg:grid-cols-[1.02fr_0.98fr] lg:py-20">
          <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="flex flex-col justify-center">
            <div className="mb-4 inline-flex w-fit items-center gap-2 rounded-full border border-amber-200 bg-white/90 px-4 py-2 text-sm font-semibold text-amber-700 shadow-sm">
              <FaStar className="text-amber-500" /> DEFENCE COLONY OUTLET
            </div>
            <h1 className="max-w-2xl text-4xl font-bold leading-tight text-[#3a2e2a] md:text-5xl lg:text-5xl">
              Best Spa in <span className="text-amber-700">Defence Colony</span> Near the Market
            </h1>
            <p className="mt-4 max-w-2xl text-lg leading-relaxed text-gray-700">
              Looking for a spa in Defence Colony? Spa Delhi is a trusted destination for massage Defence Colony, deep tissue therapy, and body spa in Defence Colony sessions, just minutes from Defence Colony Market, the flyover, and Moolchand Metro Station. Every body massage Defence Colony session is performed by certified therapists in a clean, private setting. First visit from ₹1999.
            </p>
            <p className="mt-4 max-w-2xl leading-relaxed text-gray-600">
              Whether you're shopping at Defence Colony Market, live around Lajpat Nagar or South Extension, or are simply passing through South Delhi, our outlet and our home spa network mean the best spa in Defence Colony experience is never far away.
            </p>
          ...
          <motion.div initial={{ opacity: 0, x: 24 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.7 }} className="relative flex items-center">
            <div className="w-full rounded-[32px] border border-amber-100 bg-white p-3 shadow-[0_20px_60px_-20px_rgba(0,0,0,0.25)]">
              <div className="relative h-[410px] overflow-hidden rounded-[24px]">
                <Image src="/images/fpkdl.com_960_1758962686_masseur-doing-massage-woman-s-back-spa-salon-with-many-candles_355000-245.jpg" alt="Therapist giving a massage at our spa in Defence Colony" fill className="object-cover" priority />
              </div>
            </div>
      ...
      <section className="mx-auto max-w-6xl px-6 py-16">
        <div className="mb-10 text-center">
          ...
          <h2 className="mt-3 text-3xl font-bold text-[#3a2e2a] md:text-4xl">What Makes Our Defence Colony Spa Different?</h2>
        </div>
        ...
        <div className="grid gap-10 overflow-hidden rounded-[32px] border border-amber-100 bg-white p-6 shadow-lg lg:grid-cols-2 lg:items-center lg:p-10">
          <motion.div initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.5 }} className="relative min-h-[420px]">
            <div className="absolute left-0 top-0 z-10 w-40">
              ...
              <p className="mt-2 text-[11px] font-semibold uppercase tracking-[0.15em] text-gray-500">Luxury Spa Outlet in Defence Colony</p>
            </div>
            ...
            <div className="absolute right-0 top-0 w-[55%] overflow-hidden rounded-2xl bg-gradient-to-br from-amber-600 to-amber-800 p-2 shadow-xl sm:w-[60%]">
              <div className="relative h-32 w-full overflow-hidden rounded-xl sm:h-40">
                <Image src="/images/hotel1.jpeg" alt="Luxury hotel spa in Defence Colony" fill className="object-cover" />
              </div>
            </div>

            <div className="absolute bottom-0 left-0 h-64 w-[65%] overflow-hidden rounded-[24px] border-4 border-white shadow-xl sm:h-72">
              <Image src="/images/fpkdl.com_960_1758981994_female-masseur-preparing-bed-massage-session_23-2150461390.jpg" alt="Body massage in Defence Colony" fill className="object-cover" />
            </div>
          ...
          <motion.div initial={{ opacity: 0, x: 20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.5 }} className="mt-6 lg:mt-0">
            ...
            <h2 className="mt-3 text-3xl font-bold text-[#3a2e2a] md:text-4xl">Best Massage Spa in Defence Colony</h2>
            <p className="mt-4 leading-relaxed text-gray-700">
              Looking for the best massage spa in Defence Colony? Our spa centre sits close to Defence Colony Market, the flyover, and Moolchand Metro Station, offering calm interiors, soothing music, and premium aromatic oils. Whether after a hectic workday or a weekend at the market, our body spa in Defence Colony ensures complete rejuvenation.
            </p>
            <p className="mt-4 leading-relaxed text-gray-700">
              Our therapists are trained professionals from India and abroad, specialising in traditional and modern massage technique. Whether you prefer a gentle aromatherapy massage, an invigorating deep tissue massage, or a full body massage in Defence Colony, every session is personalised to your body's needs and your preferred pressure.
            </p>
      ...
      <section className="bg-[#f7efe8] py-16">
        <div className="mx-auto max-w-5xl px-6 text-center">
          <h2 className="text-3xl font-bold text-[#3a2e2a] md:text-4xl">Best Spa in Defence Colony — Get Full Body Massage at Home &amp; Hotel</h2>
          <p className="mx-auto mt-5 max-w-3xl leading-relaxed text-gray-600">
            Welcome to Spa Delhi — the best spa in Defence Colony. If you're tired, stressed, or need a refreshing break, our spa in Defence Colony market outlet is your perfect wellness destination. We offer a clean, luxury, and 100% hygienic ambience with a calm and secure environment for complete relaxation.
          </p>
          <p className="mx-auto mt-4 max-w-3xl leading-relaxed text-gray-600">
            With 24+ spa outlets across Delhi NCR, we're right here for you near Defence Colony Market, the flyover, and Moolchand Metro Station. Whether you want a quick stress-relief session or a deep muscle relaxation therapy, our certified and professional therapists at Spa Delhi ensure a world-class spa experience every time.
          </p>
          <p className="mx-auto mt-4 max-w-3xl leading-relaxed text-gray-600">
            Guests travelling from Lajpat Nagar, South Extension, and Jangpura regularly choose our spa in Defence Colony because we keep every detail consistent — the same trained hands, the same quality oils, and the same honest pricing on every single visit.
          </p>
      ...
      <section className="mx-auto max-w-6xl px-6 py-16 lg:py-20">
        <div className="grid gap-10 lg:grid-cols-2 lg:items-center">
          <motion.div initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.5 }}>
            <p className="text-sm font-semibold uppercase tracking-[0.3em] text-[#3a2e2a]">Defence Colony</p>
            ...
            <div className="mt-5 space-y-4 text-gray-700">
              <p>
                At Spa Delhi in Defence Colony, we offer a delightful and truly relaxing experience to relieve your body and mind of pain. With 24+ spa outlets across Delhi, Gurgaon, and Noida, our spa in Defence Colony market is known for professional body massage delivered by certified therapists.
              </p>
              <p>
              ...
              <p>
                If you want a trusted massage spa in Defence Colony, look for experienced therapists, transparent pricing, and complete cleanliness — and Spa Delhi in Defence Colony ticks all boxes. That's why we're the first choice for the best spa in Defence Colony and across South Delhi.
              </p>
            </div>
            <a href="https://t.me/+a5Bu6FBPN9FlOWM9" className="mt-6 inline-flex items-center gap-2 rounded-full bg-amber-600 px-6 py-3 font-semibold text-white shadow-lg transition hover:bg-amber-700">
              <FaTelegram /> Join Telegram Channel
          ...
          <motion.div initial={{ opacity: 0, x: 20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.5 }} className="relative h-72 overflow-hidden rounded-[28px] shadow-lg lg:h-96">
            <Image src="/images/fpkdl.com_960_1758980558_relaxing-spa-room-with-candles_1187092-239475.jpg" alt="Luxury spa Defence Colony treatment room" fill className="object-cover" />
          </motion.div>
        </div>
      </section>
      ...
      <section className="bg-[#fdf2e8] py-16 lg:py-20">
        <div className="mx-auto max-w-6xl px-6">
          <div className="mb-12 text-center">
            <p className="text-sm font-semibold uppercase tracking-[0.3em] text-amber-700">About Our Defence Colony Outlet</p>
            <h2 className="mt-3 text-3xl font-bold text-[#3a2e2a] md:text-4xl">Spa in Defence Colony — A Trusted Body Massage &amp; Wellness Centre</h2>
          </div>
          ...
          <div className="grid gap-10 lg:grid-cols-[0.85fr_1.15fr] lg:items-center">
            ...
            >
              <Image src="/images/hotel3.webp" alt="Luxury spa Defence Colony treatment room" fill className="object-cover" />
            </motion.div>

            <div>
              <p className="text-gray-700">
                Spa Delhi is the best spa in Defence Colony for guests across Lajpat Nagar, South Extension, and Jangpura — a real spa in Defence Colony market outlet, not a generic neighbourhood parlour. Our body massage spa in Defence Colony covers full body, deep tissue, B2B, and couple massage, with home and hotel spa available on request.
              </p>
              <div className="mt-6 grid gap-4 sm:grid-cols-2">
                <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.4 }} className="rounded-2xl border border-amber-100 bg-white p-5 shadow-sm">
                  ...
                  <h3 className="text-base font-semibold text-[#3a2e2a]">Luxury Spa in Defence Colony</h3>
                  <p className="mt-2 text-sm leading-relaxed text-gray-600">A refined, premium ambience close to Defence Colony Market and Moolchand Metro Station.</p>
                </motion.div>
                ...
                <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.4, delay: 0.1 }} className="rounded-2xl border border-amber-100 bg-white p-5 shadow-sm">
                  ...
                  <p className="mt-2 text-sm leading-relaxed text-gray-600">Prefer to stay in? Home spa and hotel spa near Defence Colony are both available on request.</p>
                </motion.div>
                <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.4, delay: 0.15 }} className="rounded-2xl border border-amber-100 bg-white p-5 shadow-sm">
                  ...
                  <p className="mt-2 text-sm leading-relaxed text-gray-600">No hidden charges — book the best spa in Defence Colony on WhatsApp with pricing confirmed upfront.</p>
                </motion.div>
              </div>
            </div>
          </div>
      ...
      <section className="mx-auto max-w-7xl px-6 py-16">
        <div className="grid gap-10 lg:grid-cols-2 lg:items-center">
          <motion.div initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.5 }}>
            ...
            <h2 className="mt-3 text-3xl font-bold text-[#3a2e2a] md:text-4xl">Why Choose Spa Delhi in Defence Colony?</h2>
            <p className="mt-4 leading-relaxed text-gray-700">
              Choosing a spa is about more than booking a massage. At our Defence Colony outlet, we focus on creating a calm, comfortable experience where you can take a proper break from your day.
            </p>
            <p className="mt-4 leading-relaxed text-gray-700">
              Whether you're coming from Lajpat Nagar, South Extension, or just want some personal time after a shopping trip to the market, our spa experience is built around your comfort.
            </p>
            ...
            <ul className="mt-3 space-y-2 text-gray-700">
              ...
              <li><span className="font-semibold text-[#3a2e2a]">Convenient Location</span> — Minutes from Defence Colony Market, the flyover, and Moolchand Metro Station.</li>
              <li><span className="font-semibold text-[#3a2e2a]">Body Spa in Defence Colony Home Service</span> — Same quality treatment delivered to your residence nearby.</li>
      ...
      <section className="mx-auto max-w-7xl px-6 py-16">
        <div className="mb-10 text-center">
          ...
          <h2 className="mt-3 text-3xl font-bold text-[#3a2e2a] md:text-4xl">Meet Our Expert Massage Therapists in Defence Colony</h2>
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
          {[
            ...
            >
              <Image src={t.image} alt={`${t.role} at Spa Delhi Defence Colony`} fill className="object-cover transition-transform duration-500 group-hover:scale-110" />
      ...
      <section className="bg-[#f7efe8] py-16">
        <div className="mx-auto max-w-6xl px-6">
          <div className="mb-10 text-center">
            ...
            <h2 className="mt-3 text-3xl font-bold text-[#3a2e2a] md:text-4xl">Explore Our Massage Services in Defence Colony</h2>
          </div>
      ...
      <section className="bg-[#fdf2e8] py-16">
        <div className="mx-auto max-w-5xl px-6 text-center">
          <h2 className="text-3xl font-bold text-[#3a2e2a] md:text-4xl">100% Hygienic &amp; Professional Spa in Defence Colony — Your Safety First</h2>
      ...
      <section id="Pricing" className="bg-[#fdf2e8] py-16">
        <div className="mx-auto max-w-6xl px-6">
          <div className="mb-10 text-center">
            ...
            <h2 className="mt-3 text-3xl font-bold text-[#3a2e2a] md:text-4xl">Spa in Defence Colony Pricing — Transparent &amp; Affordable</h2>
          </div>
      ...
      <section className="mx-auto max-w-4xl px-6 py-16">
        <div className="mb-10 text-center">
          ...
          <h2 className="mt-3 text-3xl font-bold text-[#3a2e2a] md:text-4xl">Your Spa in Defence Colony Questions, Answered</h2>
        </div>
      ...
      <section className="bg-[#f7efe8] py-16">
        <div className="mx-auto max-w-7xl px-6">
          <div className="mb-10 text-center">
            ...
            <p className="mx-auto mt-4 max-w-2xl text-gray-600">
              Not based in Defence Colony? We run 24+ outlets across Delhi NCR — find the one closest to you.
            </p>
        ...
        <div className="rounded-[32px] bg-gradient-to-r from-[#3a2e2a] to-[#5b3f31] p-8 text-white shadow-2xl md:p-10">
          <div className="flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
            <div className="max-w-2xl">
              ...
              <h3 className="mt-2 text-3xl font-bold md:text-4xl">Book the Best Spa in Defence Colony — Today</h3>
              <p className="mt-3 leading-relaxed text-white/80">Walk in near Defence Colony Market, or connect with us for a home or hotel spa booking anywhere in Defence Colony and South Delhi.</p>
            </div>
