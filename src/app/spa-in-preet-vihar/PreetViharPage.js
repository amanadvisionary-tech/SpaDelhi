...
const highlights = [
  {
    ...
    title: "A Genuine Spa in Preet Vihar",
    desc: "A real luxury spa in Preet Vihar outlet — trained therapists, premium oils, and a private room for every session, not a rushed neighbourhood parlour visit.",
  },
  {
    icon: <FaHandSparkles className="text-2xl text-emerald-600" />,
    title: "Minutes From Preet Vihar Metro & Vikas Marg",
    desc: "Close to Preet Vihar Metro Station, Vikas Marg, V3S Mall, and Karkardooma, easy to reach from across East Delhi.",
  },
  {
    icon: <FaHeart className="text-2xl text-rose-500" />,
    title: "Outlet, Home & Hotel Spa Options",
    desc: "Visit our preet vihar spa centre, or book a body spa in Preet Vihar home service anywhere nearby.",
  },
];

const services = [
  { title: "Full Body Massage", desc: "A complete full body massage in Preet Vihar that eases muscle tension, improves circulation, and leaves you feeling genuinely refreshed from head to toe.", href: "/full-body-massage-in-delhi" },
  { title: "Deep Tissue Massage", desc: "Firm, focused deep tissue massage in Preet Vihar that targets chronic knots in the back, neck, and shoulders built up from long hours at a desk.", href: "/deep-tissue-massage-in-delhi" },
  ...
  { title: "Couples Massage", desc: "One private room, two therapists — a shared couple massage in Preet Vihar experience designed for two people to unwind together.", href: "/couples-massage-in-delhi" },
...
const faqs = [
  ...
  { question: "Can I book a couple massage in Preet Vihar?", answer: "Yes, our Preet Vihar outlet has private rooms designed for couple massage, including our popular female to male couple massage, so two people can relax together in complete comfort." },
  ...
  return (
    <main className="min-h-screen bg-[#fffaf6] text-[#2f241d]">
      ...
      <section className="relative overflow-hidden bg-[radial-gradient(circle_at_top_left,_rgba(245,158,11,0.18),_transparent_30%),linear-gradient(135deg,_#fef7ed_0%,_#fffaf5_45%,_#fef3f2_100%)]">
        <div className="absolute inset-0 bg-[url('/images/fpkdl.com_960_1758982094_exfoliation-with-natural-bristle-brush-dry-brush-massage-preparing-skin-epilation_470400-470.jpg')] bg-cover bg-center opacity-10" />
        ...
        <div className="relative mx-auto grid max-w-7xl gap-10 px-6 py-16 lg:grid-cols-[1.02fr_0.98fr] lg:py-20">
          <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="flex flex-col justify-center">
            <div className="mb-4 inline-flex w-fit items-center gap-2 rounded-full border border-amber-200 bg-white/90 px-4 py-2 text-sm font-semibold text-amber-700 shadow-sm">
              <FaStar className="text-amber-500" /> PREET VIHAR OUTLET
            </div>
          ...
          <motion.div initial={{ opacity: 0, x: 24 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.7 }} className="relative flex items-center">
            <div className="w-full rounded-[32px] border border-amber-100 bg-white p-3 shadow-[0_20px_60px_-20px_rgba(0,0,0,0.25)]">
              <div className="relative h-[410px] overflow-hidden rounded-[24px]">
                <Image src="/images/fpkdl.com_960_1758982094_exfoliation-with-natural-bristle-brush-dry-brush-massage-preparing-skin-epilation_470400-470.jpg" alt="Therapist giving a massage at our spa in Preet Vihar" fill className="object-cover" priority />
              </div>
            </div>
      ...
      <section className="mx-auto max-w-6xl px-6 py-16">
        <div className="mb-10 text-center">
          ...
          <h2 className="mt-3 text-3xl font-bold text-[#3a2e2a] md:text-4xl">What Makes Our Preet Vihar Spa Different?</h2>
        </div>
        ...
        <div className="grid gap-10 overflow-hidden rounded-[32px] border border-amber-100 bg-white p-6 shadow-lg lg:grid-cols-2 lg:items-center lg:p-10">
          <motion.div initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.5 }} className="relative min-h-[420px]">
            <div className="absolute left-0 top-0 z-10 w-40">
              ...
              <p className="mt-2 text-[11px] font-semibold uppercase tracking-[0.15em] text-gray-500">Luxury Spa Outlet in Preet Vihar</p>
            </div>
            ...
            <div className="absolute right-0 top-0 w-[55%] overflow-hidden rounded-2xl bg-gradient-to-br from-amber-600 to-amber-800 p-2 shadow-xl sm:w-[60%]">
              <div className="relative h-32 w-full overflow-hidden rounded-xl sm:h-40">
                <Image src="/images/hotel1.jpeg" alt="Luxury hotel spa in Preet Vihar" fill className="object-cover" />
              </div>
            </div>

            <div className="absolute bottom-0 left-0 h-64 w-[65%] overflow-hidden rounded-[24px] border-4 border-white shadow-xl sm:h-72">
              <Image src="/images/fpkdl.com_960_1758982753_woman-getting-back-massage-from-female-masseur_23-2150461424.jpg" alt="Body massage in Preet Vihar" fill className="object-cover" />
            </div>
          ...
          <motion.div initial={{ opacity: 0, x: 20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.5 }} className="mt-6 lg:mt-0">
            ...
            <h2 className="mt-3 text-3xl font-bold text-[#3a2e2a] md:text-4xl">Best Massage Spa in Preet Vihar</h2>
            <p className="mt-4 leading-relaxed text-gray-700">
              Looking for the best massage spa in Preet Vihar? Our spa centre sits close to Preet Vihar Metro Station, Vikas Marg, and V3S Mall, offering calm interiors, soothing music, and premium aromatic oils. Whether after a hectic workday or a weekend outing, our body spa in Preet Vihar ensures complete rejuvenation.
            </p>
            <p className="mt-4 leading-relaxed text-gray-700">
              Our therapists are trained professionals from India and abroad, specialising in traditional and modern massage technique. Whether you prefer a gentle aromatherapy massage, an invigorating deep tissue massage, or a full body massage in Preet Vihar, every session is personalised to your body's needs and your preferred pressure.
            </p>
      ...
      <section className="bg-[#f7efe8] py-16">
        <div className="mx-auto max-w-5xl px-6 text-center">
          <h2 className="text-3xl font-bold text-[#3a2e2a] md:text-4xl">Best Spa in Preet Vihar — Get Full Body Massage at Home &amp; Hotel</h2>
      ...
      <section className="mx-auto max-w-6xl px-6 py-16 lg:py-20">
        <div className="grid gap-10 lg:grid-cols-2 lg:items-center">
          <motion.div initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.5 }}>
            <p className="text-sm font-semibold uppercase tracking-[0.3em] text-[#3a2e2a]">Preet Vihar</p>
          ...
          <motion.div initial={{ opacity: 0, x: 20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.5 }} className="relative h-72 overflow-hidden rounded-[28px] shadow-lg lg:h-96">
            <Image src="/images/hotel3.webp" alt="Luxury spa Preet Vihar treatment room" fill className="object-cover" />
          </motion.div>
        </div>
      </section>
      ...
      <section className="bg-[#fdf2e8] py-16 lg:py-20">
        <div className="mx-auto max-w-6xl px-6">
          <div className="mb-12 text-center">
            <p className="text-sm font-semibold uppercase tracking-[0.3em] text-amber-700">About Our Preet Vihar Outlet</p>
            <h2 className="mt-3 text-3xl font-bold text-[#3a2e2a] md:text-4xl">Spa in Preet Vihar — A Trusted Body Massage &amp; Wellness Centre</h2>
          </div>
          ...
          <div className="grid gap-10 lg:grid-cols-[0.85fr_1.15fr] lg:items-center">
            ...
            >
              <Image src="/images/luxurySpaRoom.jpg" alt="Luxury spa Preet Vihar treatment room" fill className="object-cover" />
            </motion.div>
            ...
            <div>
              ...
              <div className="mt-6 grid gap-4 sm:grid-cols-2">
                <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.4 }} className="rounded-2xl border border-amber-100 bg-white p-5 shadow-sm">
                  ...
                  <h3 className="text-base font-semibold text-[#3a2e2a]">Luxury Spa in Preet Vihar</h3>
                  <p className="mt-2 text-sm leading-relaxed text-gray-600">A refined, premium ambience close to Preet Vihar Metro Station and Vikas Marg.</p>
                </motion.div>
                <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.4, delay: 0.05 }} className="rounded-2xl border border-amber-100 bg-white p-5 shadow-sm">
                  ...
                  <p className="mt-2 text-sm leading-relaxed text-gray-600">Trained Indian and russian spa in Preet Vihar therapists deliver every session with care.</p>
                </motion.div>
                <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.4, delay: 0.1 }} className="rounded-2xl border border-amber-100 bg-white p-5 shadow-sm">
                  ...
                  <p className="mt-2 text-sm leading-relaxed text-gray-600">Prefer to stay in? Home spa and hotel spa near Preet Vihar are both available on request.</p>
                </motion.div>
                <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.4, delay: 0.15 }} className="rounded-2xl border border-amber-100 bg-white p-5 shadow-sm">
                  ...
                  <p className="mt-2 text-sm leading-relaxed text-gray-600">No hidden charges — book the best spa in Preet Vihar on WhatsApp with pricing confirmed upfront.</p>
                </motion.div>
              </div>
            </div>
          </div>
      ...
      <section className="mx-auto max-w-7xl px-6 py-16">
        <div className="grid gap-10 lg:grid-cols-2 lg:items-center">
          <motion.div initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.5 }}>
            ...
            <h2 className="mt-3 text-3xl font-bold text-[#3a2e2a] md:text-4xl">Why Choose Spa Delhi in Preet Vihar?</h2>
            <p className="mt-4 leading-relaxed text-gray-700">
            ...
            <p className="mt-4 leading-relaxed text-gray-700">
              Whether you're coming from Karkardooma, Nirman Vihar, or just want some personal time after work, our spa experience is built around your comfort and your schedule.
            </p>
            ...
            <ul className="mt-3 space-y-2 text-gray-700">
              ...
              <li><span className="font-semibold text-[#3a2e2a]">Convenient Location</span> — Minutes from Preet Vihar Metro Station, Vikas Marg, and V3S Mall.</li>
              <li><span className="font-semibold text-[#3a2e2a]">Body Spa in Preet Vihar Home Service</span> — Same quality treatment delivered to your residence nearby.</li>
      ...
      <section className="mx-auto max-w-7xl px-6 py-16">
        <div className="mb-10 text-center">
          ...
          <h2 className="mt-3 text-3xl font-bold text-[#3a2e2a] md:text-4xl">Meet Our Expert Massage Therapists in Preet Vihar</h2>
          <p className="mx-auto mt-3 max-w-2xl text-gray-600">A mix of skilled Indian and foreigner therapists, so you get real variety in technique for every massage in Preet Vihar session.</p>
        </div>
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
          {[
            { role: "Senior Massage Therapist", specialty: "Full Body & Deep Tissue", experience: "8+ yrs", image: "/images/staff2.jpg" },
            { role: "Foreigner Therapist", specialty: "Russian & Aromatherapy", experience: "6+ yrs", image: "/images/staff4.jpg" },
      ...
      <section className="bg-[#f7efe8] py-16">
        <div className="mx-auto max-w-6xl px-6">
          <div className="mb-10 text-center">
            ...
            <h2 className="mt-3 text-3xl font-bold text-[#3a2e2a] md:text-4xl">Explore Our Massage Services in Preet Vihar</h2>
          </div>
      ...
      <section className="bg-[#fdf2e8] py-16">
        <div className="mx-auto max-w-5xl px-6 text-center">
          <h2 className="text-3xl font-bold text-[#3a2e2a] md:text-4xl">100% Hygienic &amp; Professional Spa in Preet Vihar — Your Safety First</h2>
          <p className="mx-auto mt-4 max-w-2xl text-gray-600">
            From a hot shower to a full steam bath, these are the small details that turn a massage into a complete spa visit — and the reason returning guests trust our massage center in Preet Vihar again and again.
          </p>
      ...
      <section id="Pricing" className="bg-[#fdf2e8] py-16">
        <div className="mx-auto max-w-6xl px-6">
          <div className="mb-10 text-center">
            ...
            <h2 className="mt-3 text-3xl font-bold text-[#3a2e2a] md:text-4xl">Spa in Preet Vihar Pricing — Transparent &amp; Affordable</h2>
          </div>
      ...
      <section className="mx-auto max-w-4xl px-6 py-16">
        <div className="mb-10 text-center">
          ...
          <h2 className="mt-3 text-3xl font-bold text-[#3a2e2a] md:text-4xl">Your Spa in Preet Vihar Questions, Answered</h2>
        </div>
      ...
      <section className="bg-[#f7efe8] py-16">
        <div className="mx-auto max-w-7xl px-6">
          <div className="mb-10 text-center">
            ...
            <p className="mx-auto mt-4 max-w-2xl text-gray-600">
              Not based in Preet Vihar? We run 24+ outlets across Delhi NCR — find the one closest to you.
            </p>
        ...
        <div className="rounded-[32px] bg-gradient-to-r from-[#3a2e2a] to-[#5b3f31] p-8 text-white shadow-2xl md:p-10">
          <div className="flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
            <div className="max-w-2xl">
              ...
              <h3 className="mt-2 text-3xl font-bold md:text-4xl">Book the Best Spa in Preet Vihar — Today</h3>
