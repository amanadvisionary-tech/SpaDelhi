...
const highlights = [
  {
    ...
    title: "A Genuine Spa in Laxmi Nagar",
    desc: "A real body spa in Laxmi Nagar outlet — trained therapists, premium oils, and a private room for every session, not a rushed neighbourhood parlour visit.",
  },
  {
    icon: <FaHandSparkles className="text-2xl text-emerald-600" />,
    title: "Minutes From Laxmi Nagar Metro & Vikas Marg",
    desc: "Close to Laxmi Nagar Metro Station, Vikas Marg, and the DDA Market, easy to reach from across East Delhi.",
  },
  {
    icon: <FaHeart className="text-2xl text-rose-500" />,
    title: "Outlet, Home & Hotel Spa Options",
    desc: "Visit our spa in Laxmi Nagar Delhi outlet, or book a body massage spa in Laxmi Nagar Delhi home service anywhere nearby.",
  },
];
...
const services = [
  ...
  { title: "Couples Massage", desc: "One private room, two therapists — a shared couple massage experience designed for two people to unwind together.", href: "/couples-massage-in-delhi" },
...
const pricingPlans = [
  { title: "Spa Outlet", price: "₹1999", desc: "A private massage in Laxmi Nagar session at our outlet, with premium oils and complete privacy from start to finish.", features: ["Oil Massage", "Cream Massage", "Private Room", "60 min Session"], icon: <FaSpa className="text-amber-500" />, highlight: false, badge: "Starter" },
  { title: "Home Spa", price: "₹15000", desc: "The same genuine body massage spa in Laxmi Nagar experience, delivered to your home anywhere nearby.", features: ["Therapist of Choice", "Private Setting", "Aromatherapy Add-on", "90 min Session"], icon: <FaCrown className="text-amber-500" />, highlight: false, badge: "Flexible" },
...
const faqs = [
  { question: "Is there a good spa in Laxmi Nagar near the metro station?", answer: "Yes, Spa Delhi runs a genuine spa in Laxmi Nagar, close to Laxmi Nagar Metro Station and Vikas Marg, offering full body, deep tissue, and B2B massage in a private, hygienic setting for guests across East Delhi." },
  { question: "What makes Spa Delhi the best spa in Laxmi Nagar?", answer: "Certified therapists, transparent pricing, hygienic private rooms, and flexible outlet, home, and hotel spa options make us the best spa in Laxmi Nagar for residents across East Delhi, from Shakarpur to Nirman Vihar." },
  { question: "Do you offer body massage in Laxmi Nagar for both men and women?", answer: "Yes, our body massage in Laxmi Nagar welcomes both men and women, with male and female therapist options available — just mention your preference when booking your session." },
  ...
  return (
    <main className="min-h-screen bg-[#fffaf6] text-[#2f241d]">
      ...
      <section className="relative overflow-hidden bg-[radial-gradient(circle_at_top_left,_rgba(245,158,11,0.18),_transparent_30%),linear-gradient(135deg,_#fef7ed_0%,_#fffaf5_45%,_#fef3f2_100%)]">
        <div className="absolute inset-0 bg-[url('/images/fpkdl.com_750_1758779654_happy-pretty-lady-lying-down-massage-bed-wellness-center-beauty-concept_151013-4029.jpg')] bg-cover bg-center opacity-10" />
        ...
        <div className="relative mx-auto grid max-w-7xl gap-10 px-6 py-16 lg:grid-cols-[1.02fr_0.98fr] lg:py-20">
          <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="flex flex-col justify-center">
            <div className="mb-4 inline-flex w-fit items-center gap-2 rounded-full border border-amber-200 bg-white/90 px-4 py-2 text-sm font-semibold text-amber-700 shadow-sm">
              <FaStar className="text-amber-500" /> LAXMI NAGAR OUTLET
            </div>
            <h1 className="max-w-2xl text-4xl font-bold leading-tight text-[#3a2e2a] md:text-5xl lg:text-5xl">
              Best Spa in <span className="text-amber-700">Laxmi Nagar</span> Near Vikas Marg
            </h1>
            <p className="mt-4 max-w-2xl text-lg leading-relaxed text-gray-700">
              Looking for a spa in Laxmi Nagar? Spa Delhi is a trusted spa in Laxmi Nagar Delhi destination for full body massage, deep tissue therapy, and body spa in Laxmi Nagar sessions, just minutes from Laxmi Nagar Metro Station and Vikas Marg. Every massage in Laxmi Nagar session is performed by certified therapists in a clean, private setting. First visit from ₹1999.
            </p>
            <p className="mt-4 max-w-2xl leading-relaxed text-gray-600">
              Whether you work near the DDA Market, live around Shakarpur or Nirman Vihar, or are simply passing through East Delhi, our outlet and our home spa network mean the best spa in Laxmi Nagar experience is never far away.
            </p>
          ...
          <motion.div initial={{ opacity: 0, x: 24 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.7 }} className="relative flex items-center">
            <div className="w-full rounded-[32px] border border-amber-100 bg-white p-3 shadow-[0_20px_60px_-20px_rgba(0,0,0,0.25)]">
              <div className="relative h-[410px] overflow-hidden rounded-[24px]">
                <Image src="/images/fpkdl.com_750_1758779654_happy-pretty-lady-lying-down-massage-bed-wellness-center-beauty-concept_151013-4029.jpg" alt="Therapist giving a massage at our spa in Laxmi Nagar" fill className="object-cover" priority />
              </div>
            </div>
      ...
      <section className="mx-auto max-w-6xl px-6 py-16">
        <div className="mb-10 text-center">
          ...
          <h2 className="mt-3 text-3xl font-bold text-[#3a2e2a] md:text-4xl">What Makes Our Laxmi Nagar Spa Different?</h2>
        </div>
        ...
        <div className="grid gap-10 overflow-hidden rounded-[32px] border border-amber-100 bg-white p-6 shadow-lg lg:grid-cols-2 lg:items-center lg:p-10">
          <motion.div initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.5 }} className="relative min-h-[420px]">
            <div className="absolute left-0 top-0 z-10 w-40">
              ...
              <p className="mt-2 text-[11px] font-semibold uppercase tracking-[0.15em] text-gray-500">Luxury Spa Outlet in Laxmi Nagar</p>
            </div>
            ...
            <div className="absolute right-0 top-0 w-[55%] overflow-hidden rounded-2xl bg-gradient-to-br from-amber-600 to-amber-800 p-2 shadow-xl sm:w-[60%]">
              <div className="relative h-32 w-full overflow-hidden rounded-xl sm:h-40">
                <Image src="/images/hotel2.jpg" alt="Luxury hotel spa in Laxmi Nagar" fill className="object-cover" />
              </div>
            </div>

            <div className="absolute bottom-0 left-0 h-64 w-[65%] overflow-hidden rounded-[24px] border-4 border-white shadow-xl sm:h-72">
              <Image src="/images/fpkdl.com_960_1758982753_woman-getting-back-massage-from-female-masseur_23-2150461424.jpg" alt="Body massage in Laxmi Nagar" fill className="object-cover" />
            </div>
          ...
          <motion.div initial={{ opacity: 0, x: 20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.5 }} className="mt-6 lg:mt-0">
            ...
            <h2 className="mt-3 text-3xl font-bold text-[#3a2e2a] md:text-4xl">Best Massage Spa in Laxmi Nagar</h2>
            <p className="mt-4 leading-relaxed text-gray-700">
              Looking for the best spa in Laxmi Nagar? Our spa centre sits close to Laxmi Nagar Metro Station, Vikas Marg, and the DDA Market, offering calm interiors, soothing music, and premium aromatic oils. Whether after a hectic workday or a weekend outing, our body spa in Laxmi Nagar ensures complete rejuvenation.
            </p>
            <p className="mt-4 leading-relaxed text-gray-700">
              Our therapists are trained professionals from India and abroad, specialising in traditional and modern massage technique. Whether you prefer a gentle aromatherapy massage, an invigorating deep tissue massage, or a full body massage in Laxmi Nagar, every session is personalised to your body's needs and your preferred pressure.
            </p>
      ...
      <section className="bg-[#f7efe8] py-16">
        <div className="mx-auto max-w-5xl px-6 text-center">
          <h2 className="text-3xl font-bold text-[#3a2e2a] md:text-4xl">Best Spa in Laxmi Nagar — Get Full Body Massage at Home &amp; Hotel</h2>
          <p className="mx-auto mt-5 max-w-3xl leading-relaxed text-gray-600">
            Welcome to Spa Delhi — the best spa in Laxmi Nagar. If you're tired, stressed, or need a refreshing break, our spa in Laxmi Nagar Delhi outlet is your perfect wellness destination. We offer a clean, luxury, and 100% hygienic ambience with a calm and secure environment for complete relaxation.
          </p>
          <p className="mx-auto mt-4 max-w-3xl leading-relaxed text-gray-600">
            With 24+ spa outlets across Delhi NCR, we're right here for you near Laxmi Nagar Metro Station and Vikas Marg. Whether you want a quick stress-relief session or a deep muscle relaxation therapy, our certified and professional therapists at Spa Delhi ensure a world-class spa experience every time.
          </p>
          <p className="mx-auto mt-4 max-w-3xl leading-relaxed text-gray-600">
            Guests travelling from Shakarpur, Nirman Vihar, and Preet Vihar regularly choose our spa laxmi nagar Delhi outlet because we keep every detail consistent — the same trained hands, the same quality oils, and the same honest pricing on every single visit.
          </p>
      ...
      <section className="mx-auto max-w-6xl px-6 py-16 lg:py-20">
        <div className="grid gap-10 lg:grid-cols-2 lg:items-center">
          <motion.div initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.5 }}>
            <p className="text-sm font-semibold uppercase tracking-[0.3em] text-[#3a2e2a]">Laxmi Nagar</p>
            ...
            <div className="mt-5 space-y-4 text-gray-700">
              <p>
                At Spa Delhi in Laxmi Nagar, we offer a delightful and truly relaxing experience to relieve your body and mind of pain. With 24+ spa outlets across Delhi, Gurgaon, and Noida, our spa in Laxminagar is known for professional body massage delivered by certified therapists.
              </p>
              <p>
              ...
              <p>
                If you want a trusted body massage spa laxmi nagar experience, look for experienced therapists, transparent pricing, and complete cleanliness — and Spa Delhi in Laxmi Nagar ticks all boxes. That's why we're the first choice for the best spa in Laxmi Nagar and across East Delhi.
              </p>
            </div>
            <a href="https://t.me/+a5Bu6FBPN9FlOWM9" className="mt-6 inline-flex items-center gap-2 rounded-full bg-amber-600 px-6 py-3 font-semibold text-white shadow-lg transition hover:bg-amber-700">
              <FaTelegram /> Join Telegram Channel
          ...
          <motion.div initial={{ opacity: 0, x: 20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.5 }} className="relative h-72 overflow-hidden rounded-[28px] shadow-lg lg:h-96">
            <Image src="/images/spa-treatments.jpg" alt="Luxury spa Laxmi Nagar treatment room" fill className="object-cover" />
          </motion.div>
        </div>
      </section>
      ...
      <section className="bg-[#fdf2e8] py-16 lg:py-20">
        <div className="mx-auto max-w-6xl px-6">
          <div className="mb-12 text-center">
            <p className="text-sm font-semibold uppercase tracking-[0.3em] text-amber-700">About Our Laxmi Nagar Outlet</p>
            <h2 className="mt-3 text-3xl font-bold text-[#3a2e2a] md:text-4xl">Spa in Laxmi Nagar — A Trusted Body Massage &amp; Wellness Centre</h2>
          </div>
          ...
          <div className="grid gap-10 lg:grid-cols-[0.85fr_1.15fr] lg:items-center">
            ...
            >
              <Image src="/images/luxurySpaRoom.jpg" alt="Luxury spa Laxmi Nagar treatment room" fill className="object-cover" />
            </motion.div>

            <div>
              <p className="text-gray-700">
                Spa Delhi is the best spa in Laxmi Nagar for guests across Vikas Marg, Shakarpur, and Nirman Vihar — a real spa in Laxmi Nagar Delhi outlet, not a generic neighbourhood parlour. Our body massage spa in Laxmi Nagar Delhi covers full body, deep tissue, B2B, and couple massage, with home and hotel spa available on request.
              </p>
              <div className="mt-6 grid gap-4 sm:grid-cols-2">
                <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.4 }} className="rounded-2xl border border-amber-100 bg-white p-5 shadow-sm">
                  ...
                  <h3 className="text-base font-semibold text-[#3a2e2a]">Luxury Spa in Laxmi Nagar</h3>
                  <p className="mt-2 text-sm leading-relaxed text-gray-600">A refined, premium ambience close to Laxmi Nagar Metro Station and Vikas Marg.</p>
                </motion.div>
                <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.4, delay: 0.05 }} className="rounded-2xl border border-amber-100 bg-white p-5 shadow-sm">
                  ...
                  <p className="mt-2 text-sm leading-relaxed text-gray-600">Trained Indian and international therapists deliver every massage in Laxmi Nagar with care.</p>
                </motion.div>
                <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.4, delay: 0.1 }} className="rounded-2xl border border-amber-100 bg-white p-5 shadow-sm">
                  ...
                  <p className="mt-2 text-sm leading-relaxed text-gray-600">Prefer to stay in? Home spa and hotel spa near Laxmi Nagar are both available on request.</p>
                </motion.div>
                <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.4, delay: 0.15 }} className="rounded-2xl border border-amber-100 bg-white p-5 shadow-sm">
                  ...
                  <p className="mt-2 text-sm leading-relaxed text-gray-600">No hidden charges — book the best spa in Laxmi Nagar on WhatsApp with pricing confirmed upfront.</p>
                </motion.div>
              </div>
            </div>
          </div>
      ...
      <section className="mx-auto max-w-7xl px-6 py-16">
        <div className="grid gap-10 lg:grid-cols-2 lg:items-center">
          <motion.div initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.5 }}>
            ...
            <h2 className="mt-3 text-3xl font-bold text-[#3a2e2a] md:text-4xl">Why Choose Spa Delhi in Laxmi Nagar?</h2>
            <p className="mt-4 leading-relaxed text-gray-700">
              Choosing a spa is about more than booking a massage. At our Laxmi Nagar outlet, we focus on creating a calm, comfortable experience where you can take a proper break from your day.
            </p>
            <p className="mt-4 leading-relaxed text-gray-700">
              Whether you're coming from Shakarpur, Nirman Vihar, or just want some personal time after work, our spa experience is built around your comfort.
            </p>
            <h3 className="mt-6 font-semibold text-[#3a2e2a]">Why guests choose us:</h3>
            <ul className="mt-3 space-y-2 text-gray-700">
              <li><span className="font-semibold text-[#3a2e2a]">Experienced Therapists</span> — Professional care, including international therapists, with attention to your comfort and preferences.</li>
              ...
              <li><span className="font-semibold text-[#3a2e2a]">Convenient Location</span> — Minutes from Laxmi Nagar Metro Station and Vikas Marg.</li>
              <li><span className="font-semibold text-[#3a2e2a]">Body Spa in Laxmi Nagar Home Service</span> — Same quality treatment delivered to your residence nearby.</li>
      ...
      <section className="mx-auto max-w-7xl px-6 py-16">
        <div className="mb-10 text-center">
          ...
          <h2 className="mt-3 text-3xl font-bold text-[#3a2e2a] md:text-4xl">Meet Our Expert Massage Therapists in Laxmi Nagar</h2>
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
          {[
            ...
            >
              <Image src={t.image} alt={`${t.role} at Spa Delhi Laxmi Nagar`} fill className="object-cover transition-transform duration-500 group-hover:scale-110" />
      ...
      <section className="bg-[#f7efe8] py-16">
        <div className="mx-auto max-w-6xl px-6">
          <div className="mb-10 text-center">
            ...
            <h2 className="mt-3 text-3xl font-bold text-[#3a2e2a] md:text-4xl">Explore Our Massage Services in Laxmi Nagar</h2>
          </div>
      ...
      <section className="bg-[#fdf2e8] py-16">
        <div className="mx-auto max-w-5xl px-6 text-center">
          <h2 className="text-3xl font-bold text-[#3a2e2a] md:text-4xl">100% Hygienic &amp; Professional Spa in Laxmi Nagar — Your Safety First</h2>
      ...
      <section id="Pricing" className="bg-[#fdf2e8] py-16">
        <div className="mx-auto max-w-6xl px-6">
          <div className="mb-10 text-center">
            ...
            <h2 className="mt-3 text-3xl font-bold text-[#3a2e2a] md:text-4xl">Spa in Laxmi Nagar Pricing — Transparent &amp; Affordable</h2>
          </div>
      ...
      <section className="mx-auto max-w-4xl px-6 py-16">
        <div className="mb-10 text-center">
          ...
          <h2 className="mt-3 text-3xl font-bold text-[#3a2e2a] md:text-4xl">Your Spa in Laxmi Nagar Questions, Answered</h2>
        </div>
      ...
      <section className="bg-[#f7efe8] py-16">
        <div className="mx-auto max-w-7xl px-6">
          <div className="mb-10 text-center">
            ...
            <p className="mx-auto mt-4 max-w-2xl text-gray-600">
              Not based in Laxmi Nagar? We run 24+ outlets across Delhi NCR — find the one closest to you.
            </p>
          ...
          <div className="grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-5">
            {[
              ...
              { title: "Punjabi Bagh", href: "/spa-in-punjabi-bagh", image: "/images/hotel4.jpg" },
              { title: "Karol Bagh", href: "/spa-in-karol-bagh", image: "/images/spa-in-Connaught-place.png" },
        ...
        <div className="rounded-[32px] bg-gradient-to-r from-[#3a2e2a] to-[#5b3f31] p-8 text-white shadow-2xl md:p-10">
          <div className="flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
            <div className="max-w-2xl">
              ...
              <h3 className="mt-2 text-3xl font-bold md:text-4xl">Book the Best Spa in Laxmi Nagar — Today</h3>
              <p className="mt-3 leading-relaxed text-white/80">Walk in near Vikas Marg, or connect with us for a home or hotel spa booking anywhere in Laxmi Nagar and East Delhi.</p>
            </div>
