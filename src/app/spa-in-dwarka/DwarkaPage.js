...
const highlights = [
  {
    ...
    title: "Private wellness rooms in Dwarka",
    desc: "Relax in clean, private treatment rooms designed for total comfort, close to Dwarka Sector 21 and Dwarka Mor.",
  },
  {
    icon: <FaPlaneDeparture className="text-2xl text-sky-600" />,
    title: "Convenient for airport travellers",
    desc: "Just minutes from IGI Airport and Dwarka Sector 21 Metro, ideal for a relaxing session before or after your flight.",
  },
  {
    icon: <FaHeart className="text-2xl text-rose-500" />,
    title: "Outlet, home & hotel spa options",
    desc: "Visit our Dwarka spa outlet, or book a home spa or hotel spa session anywhere across South West Delhi.",
  },
];

const services = [
  {
    title: "Full Body Massage in Dwarka",
  ...
  {
    title: "Couple Massage in Dwarka",
...
const nearbyAreas = [
  {
    title: "Dwarka Mor",
    image: "/images/fpkdl.com_960_1758982563_side-view-woman-getting-massaged-spa_23-2149871287.jpg",
    description:
      "Guests from Dwarka Mor and Nawada regularly visit our Dwarka outlet for a relaxing full body or deep tissue massage session.",
  },
  {
    title: "Uttam Nagar",
    ...
    description:
      "A short drive from Uttam Nagar East and West brings you to our hygienic, professionally staffed spa in Dwarka.",
  },
  {
    title: "Janakpuri",
    image: "/images/fpkdl.com_960_1758982753_woman-getting-back-massage-from-female-masseur_23-2150461424.jpg",
    description:
      "Residents near Janakpuri West Metro Station appreciate the short travel time and calm, private setting at our Dwarka spa.",
  },
  {
    title: "Vasant Kunj",
    image: "/images/fpkdl.com_960_1758982094_exfoliation-with-natural-bristle-brush-dry-brush-massage-preparing-skin-epilation_470400-470.jpg",
    description:
      "Travellers and residents near Vasant Kunj often choose our Dwarka outlet for its convenient location and trained therapists.",
  },
];
...
const processSteps = [
  {
    ...
    text: "Share your preferred treatment, timing, and location in Dwarka. Our team helps you choose the right session with ease.",
  ...
  },
  {
    ...
    text: "Arrive at our Dwarka outlet, or welcome our therapist at your home or hotel, and enjoy a smooth, professional session.",
...
const pricingPlans = [
  {
    title: "Spa Outlet",
    price: "₹1999",
    desc: "Perfect for a quick, relaxing reset at our Dwarka outlet with premium oils and complete privacy.",
  ...
  },
  {
    title: "Home Spa",
    price: "₹15000",
    desc: "A premium at-home wellness session anywhere in Dwarka, Janakpuri or nearby South West Delhi.",
  ...
  },
  {
    ...
    price: "₹20000",
    desc: "A comprehensive luxury spa experience delivered to your hotel room, ideal for airport layovers and business travel.",
...
const faqs = [
  {
    question: "What is the first visit offer for spa in Dwarka?",
    answer:
      "Our spa in Dwarka offers a special first visit package starting at just ₹1999. This introductory offer is designed for new guests who want to experience a premium massage in Dwarka at an affordable price.",
  },
  {
    question: "Is your spa near Dwarka Sector 21 Metro Station and IGI Airport?",
    answer:
      "Yes, our Dwarka spa outlet is conveniently located close to Dwarka Sector 21 Metro Station and IGI Airport, making it an easy stop before or after a flight, or for guests travelling from Dwarka Mor and Uttam Nagar.",
  },
  {
    question: "Do you provide home spa service in Dwarka?",
    answer:
      "Yes, along with our outlet, we offer home spa service across Dwarka and South West Delhi. Our therapist arrives with all the equipment needed for a relaxing, hygienic session at your residence.",
  },
  {
    question: "Are your therapists trained and certified?",
    answer:
      "Absolutely. Every therapist at our Dwarka spa is trained and certified in techniques like Swedish massage, deep tissue therapy, and aromatherapy, ensuring a safe and professional experience.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Yes, our Dwarka outlet and hotel spa service are popular with business travellers and guests near IGI Airport who want a quick, professional massage before or after their trip.",
  },
  {
    ...
    <main className="min-h-screen bg-[#fffaf6] text-[#2f241d]">
        ...
        <div className="relative mx-auto grid max-w-7xl gap-10 px-6 py-16 lg:grid-cols-[1.02fr_0.98fr] lg:py-20">
          ...
          >
            <div className="mb-4 inline-flex w-fit items-center gap-2 rounded-full border border-amber-200 bg-white/90 px-4 py-2 text-sm font-semibold text-amber-700 shadow-sm">
              <FaStar className="text-amber-500" /> DWARKA WELLNESS OUTLET
            </div>
          ...
          <motion.div initial={{ opacity: 0, x: 24 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.7 }} className="relative flex items-center">
            <div className="w-full rounded-[32px] border border-amber-100 bg-white p-3 shadow-[0_20px_60px_-20px_rgba(0,0,0,0.25)]">
              <div className="relative h-[410px] overflow-hidden rounded-[24px]">
                <Image src="/images/fpkdl.com_960_1758983028_inviting-spa-room-designed-ultimate-relaxation_1079150-61092.jpg" alt="Inviting spa room in Dwarka" fill className="object-cover" />
              </div>
            </div>
      ...
      <section className="mx-auto max-w-7xl px-6 py-16 lg:py-20">
        <div className="mb-10 text-center">
          <p className="text-sm font-semibold uppercase tracking-[0.3em] text-amber-700">Why Dwarka Chooses Us</p>
          <h2 className="mt-3 text-3xl font-bold text-[#3a2e2a] md:text-4xl">A trusted massage centre in Dwarka, built on comfort and hygiene.</h2>
        </div>
      ...
      <section className="bg-[#fdf2e8] py-16 lg:py-20">
        <div className="mx-auto max-w-5xl px-6">
          <div className="mb-10 text-center">
            ...
            <h2 className="mt-3 text-3xl font-bold text-[#3a2e2a] md:text-4xl">Spa in Dwarka — A Trusted Full Body Massage & Wellness Centre</h2>
          </div>
          <div className="space-y-5 text-lg leading-relaxed text-gray-700">
            <p>
              If you have been searching for a genuine spa in Dwarka, Spa Delhi is here to help you relax, recharge, and relieve everyday stress. We offer a complete range of massage services in Dwarka, including{" "}
      ...
      <section className="mx-auto max-w-7xl px-6 py-16 lg:py-20">
        <div className="mb-10 text-center">
          ...
          <h2 className="mt-3 text-3xl font-bold text-[#3a2e2a] md:text-4xl">Massage services available at our Dwarka spa.</h2>
        </div>
      ...
      <section className="bg-[#f7efe8] py-16 lg:py-20">
        <div className="mx-auto max-w-7xl px-6">
          <div className="mb-10 text-center">
            ...
            <h2 className="mt-3 text-3xl font-bold text-[#3a2e2a] md:text-4xl">Conveniently located near these Dwarka neighbourhoods.</h2>
      ...
      <section className="mx-auto max-w-5xl px-6 py-16 lg:py-20">
        <div className="rounded-[32px] border border-amber-100 bg-white p-8 shadow-lg md:p-10">
          ...
          <h2 className="mt-3 text-2xl font-bold text-[#3a2e2a] md:text-3xl">The best spa in Dwarka for trusted, professional care.</h2>
          <p className="mt-4 leading-relaxed text-gray-700">
            With more than a decade of experience and{" "}
            <Link href="/outlets" className="font-medium text-amber-700 underline hover:text-amber-800">24+ outlets across Delhi NCR</Link>, Spa Delhi has become a name that guests in Dwarka and South West Delhi trust for genuine, professional massage services. When you search for a massage centre in Dwarka or a body massage near me, you want assurance of safety, hygiene, and skilled hands — and that is exactly what we deliver at every session. Our therapists undergo regular training, our treatment rooms are cleaned and sanitised between every guest, and our pricing stays transparent from the moment you enquire to the moment you book.
          </p>
          <p className="mt-4 leading-relaxed text-gray-700">
            Beyond our Dwarka outlet, we also serve nearby areas including Dwarka Mor, Uttam Nagar, Janakpuri, and Vasant Kunj with the same quality of home spa and hotel spa service. Whether you need a spa near Dwarka Sector 21 or IGI Airport for a quick visit before your flight, or a longer, more indulgent wellness package on the weekend near our{" "}
            <Link href="/spa-in-rohini" className="font-medium text-amber-700 underline hover:text-amber-800">spa in Rohini</Link> or other Delhi NCR outlets, Spa Delhi is ready to help you feel your best.
          </p>
        </div>
      </section>
        ...
        <div className="rounded-[32px] bg-gradient-to-r from-[#3a2e2a] to-[#5b3f31] p-8 text-white shadow-2xl md:p-10">
          <div className="flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
            <div className="max-w-2xl">
              ...
              <h3 className="mt-2 text-3xl font-bold md:text-4xl">Reserve a peaceful escape in Dwarka today.</h3>
              <p className="mt-3 leading-relaxed text-white/80">Walk in with your comfort in mind, or connect with us for a personalised home spa or hotel spa booking anywhere in Dwarka and South West Delhi.</p>
            </div>
